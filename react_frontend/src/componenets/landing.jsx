                ...
                <div className="container">
                    <section className="landing_section">
                        ...
                        {/*<img src="src/assets/bat_man.jpg" className="main_img"></img>*/}
                            <br />
                            <h>Welcom to <b>Precise Movie Stream.</b></h> 
                            <br /> <br />
                            <h> This service helps you chose the best movie or serie for you to watch based on your answers to a specific questionnaire.</h>
                            <br /> <br />
