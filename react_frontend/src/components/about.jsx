    ...
    return(
        ...
        <div className="container">
            ...
            <div className="second_about">
                ...
                <h>The idea was inspired by the confusion that happens in the process of selecting what to watch next on a large media streaming service, then of course Holberton school and ALX africa required us to build a portfolio project. I proceeded with the idea from there.</h> <br />  <br/>             
                <h>This app provides 3 services:<br /><br /> <h style={{'color': 'red', 'font-weight': 'bold'}}>'Get public infos about a movie': </h>this permits you to lookup some public data on a movie by providing it's title.</h><br /> <br />
                <h><h style={{'color': 'red', 'font-weight': 'bold'}}>'Random Movies': </h>This provides you with a list of 10 movies each time you press 'Randomize'. the data in this functionality is not the whole IMDB content, instead we gatheared a list of some highly rated movies on imdb. and we pick 10 random movies from there each time. The length of this pool can change at any time, giving the user more movies to watch.</h> <br /><br />
